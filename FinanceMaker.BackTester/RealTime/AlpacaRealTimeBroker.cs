...
namespace FinanceMaker.BackTester.RealTime;

public class AlpacaRealTimeBroker : QCAlgorithm
{
...
public static class AlpacaQuantConnectRealTimeBroker
{
    public static void Run()
    {
        ...
        var leanPath = "lean"; // Ensure Lean CLI is installed and available in PATH
        var psi = new System.Diagnostics.ProcessStartInfo
        {
            FileName = leanPath,
            Arguments = "live start --config alpaca_config.json",
            RedirectStandardOutput = true,
            RedirectStandardError = true,
            UseShellExecute = false,
            CreateNoWindow = true
